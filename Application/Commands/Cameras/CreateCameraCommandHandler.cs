...
public class CreateCameraCommandHandler : IRequestHandler<CreateCameraCommand, CameraDto>
{
    ...
    private static CameraConfiguration CreateCameraConfiguration(CameraConfigurationDto? configDto)
    {
        ...
        return new CameraConfiguration
        {
            ...
            CameraRole = configDto.CameraRole,
            PreferredEngine = configDto.PreferredEngine,
            WorkflowMode = configDto.WorkflowMode,
            ...
            DetectionEnabled = configDto.DetectionEnabled,
            TrackingEnabled = configDto.TrackingEnabled,
            RecognitionEnabled = configDto.RecognitionEnabled,
            CompreFaceFallbackEnabled = configDto.CompreFaceFallbackEnabled,
            ...
            PitchLimitDegrees = configDto.PitchLimitDegrees ?? CameraConfiguration.Default.PitchLimitDegrees,
            RollLimitDegrees = configDto.RollLimitDegrees ?? CameraConfiguration.Default.RollLimitDegrees,
            MaxFacesPerFrame = configDto.MaxFacesPerFrame > 0 ? configDto.MaxFacesPerFrame : CameraConfiguration.Default.MaxFacesPerFrame,
            ...
            AlertCooldownMs = configDto.AlertCooldownMs >= 0 ? configDto.AlertCooldownMs : CameraConfiguration.Default.AlertCooldownMs,
            KnownFaceCooldownMs = configDto.KnownFaceCooldownMs >= 0 ? configDto.KnownFaceCooldownMs : CameraConfiguration.Default.KnownFaceCooldownMs,
            UnknownFaceCooldownMs = configDto.UnknownFaceCooldownMs >= 0 ? configDto.UnknownFaceCooldownMs : CameraConfiguration.Default.UnknownFaceCooldownMs,
            SnapshotSavingEnabled = configDto.SnapshotSavingEnabled,
            StoreUnknownFaceSnapshots = configDto.StoreUnknownFaceSnapshots,
            StoreKnownFaceSnapshots = configDto.StoreKnownFaceSnapshots,
            UnknownSnapshotRetentionDays = configDto.UnknownSnapshotRetentionDays > 0 ? configDto.UnknownSnapshotRetentionDays : CameraConfiguration.Default.UnknownSnapshotRetentionDays,
            KnownAdditionalFaceLimit = configDto.KnownAdditionalFaceLimit >= 0 ? configDto.KnownAdditionalFaceLimit : CameraConfiguration.Default.KnownAdditionalFaceLimit,
            GpuDecodingEnabled = configDto.GpuDecodingEnabled,
