...
namespace VisitorManagementSystem.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260615145356_AddLicenseRecords")]
    partial class AddLicenseRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VisitorManagementSystem.Api.Domain.Entities.AlertEscalationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AlertEscalationId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AlertEscalationLogs", (string)null);
                });

            modelBuilder.Entity("VisitorManagementSystem.Api.Domain.Entities.AlertRecipientConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AlertRecipientConfigurations", (string)null);
                });
            ...
            modelBuilder.Entity("VisitorManagementSystem.Api.Domain.Entities.BackupRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("DataFileSizeMbAtBackup")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("TriggeredByDisplay")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("StartedAt")
                        .HasDatabaseName("IX_BackupRecords_StartedAt");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_BackupRecords_Status");

                    b.HasIndex("TriggerType")
                        .HasDatabaseName("IX_BackupRecords_TriggerType");
            ...
            modelBuilder.Entity("VisitorManagementSystem.Api.Domain.Entities.LicenseRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ComponentMatchCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VisitorManagementSystem.Api.Domain.Entities.AlertEscalationLog", b =>
                {
                    b.HasOne("VisitorManagementSystem.Api.Domain.Entities.AlertEscalation", "AlertEscalation")
                        .WithMany()
                        .HasForeignKey("AlertEscalationId")
